...
public class TutorialUI : MonoBehaviour {
    ...
    private void Start() {
        ...
        SoccerGameManager.Instance.OnLocalPlayerReadyChanged += SoccerGameManager_OnLocalPlayerReadyChanged;
    ...
    private void SoccerGameManager_OnLocalPlayerReadyChanged(object sender, System.EventArgs e) {
